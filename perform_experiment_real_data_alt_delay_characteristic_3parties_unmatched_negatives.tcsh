...
while ($CURRENT_CHUNK <= $CHUNKS_COUNT)
    ...
    echo "perform_experiment_real_data_alt_delay_characteristic_3parties_unmatched_negatives($CURRENT_CHUNK, $CHUNKS_COUNT, '$DATABASES_PATH', '$MIXCORR_DATA_PATH', '$DATABASE_ID');" | octave >& $LOGS_PATH/${DATABASE_ID}_3parties_unmatched_negatives_${CURRENT_CHUNK}_of_${CHUNKS_COUNT}.log &
    echo "Done."
